...
if __name__ == "__main__":
    ...
    stopsVER = readallstops(versionVER, rec_stop, rec_stop_area, rec_stopping_points)
    ...
    restrictions = {versionidVER: readrestrictions(service_restriction, versionVER),
                    versionidHST: readrestrictions(service_restriction, versionHST)}

    lines = {45511: Line(versionVER, 45511, rec_lin_ber, lid_course, lid_travel_time_type, stopsVER),
             50510: Line(versionHST, 50510, rec_lin_ber, lid_course, lid_travel_time_type, stopsHST)}
    ...
    for lineid in lines:
        ...
        for courseid in line.courses:
            ...
            for index, row in rec_trip.query(querystring).iterrows():
                ...
                for cdate in dates:
                    # print(cdate)
                    if dayvalid(restriction, line.version, cdate, calendar_otc, day_attr, day_type_2_day_attr):
