...
with open("./rec_lin_ber.din", 'r') as linefile:
...
with open("./rec_stop.din", 'r') as stopfile:
...
with open("./rec_stopping_points.din", 'r') as platfile:
...
with open("./service_restriction.din", 'r') as restrictionfile:
...
with open("./rec_trip.din", 'r') as tripfile:
...
with open("./lid_course.din", 'r') as coursefile:
...
with open("./lid_travel_time_type.din", 'r') as timefile:
